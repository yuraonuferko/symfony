...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3302, 'dbname' => 'symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bf7dca3910e5532ba3b87ea129d2a4d3a8ebfa68724cb46a72aafe7022e95a40');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('yonuferko');
        $a->setPassword('poroshenko321');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin(array(0 => 'yura_onuferko@yahoo.com'), array());
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59008882c58527.72168509')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'yonuferko',
            'mailer_password' => 'poroshenko321',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'blogger_blog.emails.contact_email' => 'yura_onuferko@yahoo.com',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'yonuferko',
            'swiftmailer.mailer.default.transport.smtp.password' => 'poroshenko321',
            ...
            'swiftmailer.mailer.default.single_address' => 'yura_onuferko@yahoo.com',
            'swiftmailer.mailer.default.delivery_addresses' => array(
                0 => 'yura_onuferko@yahoo.com',
            ),
            ...
            'swiftmailer.single_address' => 'yura_onuferko@yahoo.com',
